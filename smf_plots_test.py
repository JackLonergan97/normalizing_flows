...
for model, color in zip(dm_models, colors):
    ...
    print('length of em_mass_infall: ' + str(len(em_massInfall)))
    print('length of em_mass_bound: ' + str(len(em_massBound)))   

    axes.hist(massInfall[subhalos], bins = 70, range = (1e6,1e11), label = 'Galacticus', fill = False, edgecolor = 'blue')
    axes.hist(em_massInfall, bins = 70, range = (1e6,1e11), label = 'Emulator', fill = False, edgecolor = 'orange')
    ...
    axes.hist(massBound[subhalos], bins = 70, range = (1e6,1e10), label = 'Galacticus', fill = False, edgecolor = 'blue')
    axes.hist(em_massBound, bins = 70, range = (1e6,1e10), label = 'Emulator', fill = False, edgecolor = 'orange')
